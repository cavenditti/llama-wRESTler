...
class ComplexityReason(str, Enum):
    ...
    REFERENCES_PREVIOUS = "references_previous"  # Payload description references other steps
...
class StepClassification(BaseModel):
    ...
    complexity: StepComplexity = Field(description="Whether this step is simple or complex")
...
class ClassificationResult(BaseModel):
    ...
    def get_simple_step_ids(self) -> set[str]:
        ...
        return {
            c.step_id for c in self.classifications 
...
def classify_steps(
    ...
    classifications = [
        classify_step(step, all_step_ids, has_credentials)
